...
Portfolio of EDA, data cleaning, wrangling, and feature-engineering projects completed during my Data Science program.
...
- **Files:** `1717584001_marketing_campaign_problem_statement.pdf`, `Marketing_Campaign - Project.pdf`, `Marketing_Campaign.ipynb`
...
- **Files:** *(Add file names once uploaded — e.g., `Sales_Analysis.ipynb`, `Sales_Report.pdf`, `sales_data.csv`)*
